...
,p_default_workspace_id=>13387160102529906748
,p_default_application_id=>49062
,p_default_owner=>'CS347_RK8596'
);
end;
/
prompt --application/set_environment
 
prompt APPLICATION 49062 - Colleges and Majors Mobile Apex App
--
-- Application Export:
--   Application:     49062
--   Name:            Colleges and Majors Mobile Apex App
--   Date and Time:   23:37 Monday November 23, 2015
--   Exported By:     RAMKOTTA@UTEXAS.EDU
--   Flashback:       0
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,49062)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'CS347_RK8596')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Colleges and Majors Mobile Apex App')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_49062')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'EEF16762A5633E723020F8B715C202ED77E48155B06CB32CFBD75826D9729EC9'
...
,p_authentication_id=>wwv_flow_api.id(15513311180330987652)
,p_application_tab_set=>0
,p_logo_image=>'TEXT:Rest Initial Project Part2 Mobile'
...
,p_csv_encoding=>'Y'
,p_last_updated_by=>'RAMKOTTA@UTEXAS.EDU'
,p_last_upd_yyyymmddhh24miss=>'20151123233714'
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(15513302379381987637)
,p_name=>'Mobile Navigation Menu'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(15513313078597987658)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(15514202993100298800)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(15513302022419987636)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(15513302118347987636)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(15513302252914987636)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(15513311009076987652)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(15513312226029987656)
,p_name=>' Breadcrumb'
);
end;
/
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(15513302449328987637)
,p_theme_id=>51
,p_name=>'Dialog'
,p_is_popup=>true
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(15513302592617987638)
,p_theme_id=>51
,p_name=>'Page'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(15513302685414987638)
,p_page_template_id=>wwv_flow_api.id(15513302592617987638)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(15513302792486987638)
,p_page_template_id=>wwv_flow_api.id(15513302592617987638)
,p_name=>'Header Bar'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(15513302835481987638)
,p_page_template_id=>wwv_flow_api.id(15513302592617987638)
,p_name=>'Footer Bar'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(15513303319576987639)
,p_theme_id=>51
,p_name=>'Popup'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(15513305745613987643)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(15513309990198987648)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15513303447730987639)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15513303546082987640)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15513303645224987640)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15513303740377987641)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15513303873423987641)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15513303996499987641)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15513304043957987641)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15513304127867987641)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15513304202939987641)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15513304359506987641)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15513304477660987641)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15513304502194987641)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15513304637107987641)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15513304705751987641)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15513304951557987642)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15513305064992987642)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15513305176287987643)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15513305254626987643)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15513305358462987643)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(15513304833982987642)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(15513305490208987643)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(15513305516033987643)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(15513305633966987643)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(15513310301391987649)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(15513310204635987648)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(15513310858025987650)
,p_theme_id=>51
,p_theme_name=>'Mobile'
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(15513302592617987638)
,p_default_dialog_template=>wwv_flow_api.id(15513302449328987637)
,p_error_template=>wwv_flow_api.id(15513302592617987638)
,p_printer_friendly_template=>wwv_flow_api.id(15513302592617987638)
,p_login_template=>wwv_flow_api.id(15513302592617987638)
,p_default_button_template=>wwv_flow_api.id(15513309990198987648)
,p_default_region_template=>wwv_flow_api.id(15513304502194987641)
,p_default_chart_template=>wwv_flow_api.id(15513304502194987641)
,p_default_form_template=>wwv_flow_api.id(15513304502194987641)
,p_default_reportr_template=>wwv_flow_api.id(15513304705751987641)
,p_default_tabform_template=>wwv_flow_api.id(15513304502194987641)
,p_default_wizard_template=>wwv_flow_api.id(15513304502194987641)
,p_default_irr_template=>wwv_flow_api.id(15513304502194987641)
,p_default_report_template=>wwv_flow_api.id(15513304833982987642)
,p_default_label_template=>wwv_flow_api.id(15513305516033987643)
,p_default_calendar_template=>wwv_flow_api.id(15513310204635987648)
,p_default_list_template=>wwv_flow_api.id(15513305176287987643)
,p_default_nav_list_template=>wwv_flow_api.id(15513305064992987642)
,p_default_top_nav_list_temp=>wwv_flow_api.id(15513305064992987642)
,p_default_side_nav_list_temp=>wwv_flow_api.id(15513305358462987643)
,p_default_nav_list_position=>'SIDE'
,p_default_dialogbtnr_template=>wwv_flow_api.id(15513303447730987639)
,p_default_dialogr_template=>wwv_flow_api.id(15513304502194987641)
,p_default_option_label=>wwv_flow_api.id(15513305516033987643)
,p_default_header_template=>wwv_flow_api.id(15513304202939987641)
,p_default_footer_template=>wwv_flow_api.id(15513304043957987641)
,p_default_required_label=>wwv_flow_api.id(15513305633966987643)
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(15513310429707987649)
,p_theme_id=>51
,p_name=>'Blue'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(15513310575823987649)
,p_theme_id=>51
,p_name=>'Dark'
,p_css_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(15513310699839987649)
,p_theme_id=>51
,p_name=>'Default'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(15513310771942987649)
,p_theme_id=>51
,p_name=>'Red'
,p_css_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(15513302914089987638)
,p_theme_id=>51
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(15513305822605987644)
,p_theme_id=>51
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(15513306638164987644)
,p_theme_id=>51
,p_name=>'ICON_BUTTON'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513303090011987639)
,p_theme_id=>51
,p_name=>'OVERLAY'
...
,p_group_id=>wwv_flow_api.id(15513302914089987638)
,p_template_types=>'PAGE'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513303182176987639)
,p_theme_id=>51
,p_name=>'PUSH'
,p_display_name=>'Push'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513303265497987639)
,p_theme_id=>51
,p_name=>'REVEAL'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513305976182987644)
,p_theme_id=>51
,p_name=>'ICON_BOTTOM'
,p_display_name=>'Bottom'
,p_display_sequence=>50
,p_button_template_id=>wwv_flow_api.id(15513305745613987643)
,p_css_classes=>'ui-btn-icon-bottom'
,p_group_id=>wwv_flow_api.id(15513305822605987644)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513306010903987644)
,p_theme_id=>51
,p_name=>'ICON_LEFT'
,p_display_name=>'Left'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513306169647987644)
,p_theme_id=>51
,p_name=>'NO_TEXT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513306269789987644)
,p_theme_id=>51
,p_name=>'ICON_RIGHT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513306388849987644)
,p_theme_id=>51
,p_name=>'ICON_TOP'
,p_display_name=>'Top'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513306474315987644)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513306519684987644)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513306776283987644)
,p_theme_id=>51
,p_name=>'ICON_ACTION'
...
,p_group_id=>wwv_flow_api.id(15513306638164987644)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513306893860987644)
,p_theme_id=>51
,p_name=>'ICON_ALERT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513306953121987644)
,p_theme_id=>51
,p_name=>'ICON_BACK'
,p_display_name=>'Back'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513307068569987644)
,p_theme_id=>51
,p_name=>'ICON_BARS'
,p_display_name=>'Bars'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513307190335987644)
,p_theme_id=>51
,p_name=>'ICON_BULLETS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513307266370987644)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513307385854987645)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513307484684987645)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513307540124987645)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513307665966987645)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513307762117987645)
,p_theme_id=>51
,p_name=>'ICON_CHECK'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513307867148987645)
,p_theme_id=>51
,p_name=>'ICON_CLOCK'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513307913461987645)
,p_theme_id=>51
,p_name=>'ICON_CLOUD'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513308020608987645)
,p_theme_id=>51
,p_name=>'ICON_COMMENT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513308144372987645)
,p_theme_id=>51
,p_name=>'ICON_DELETE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513308279364987645)
,p_theme_id=>51
,p_name=>'ICON_EDIT'
,p_display_name=>'Edit'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513308329472987645)
,p_theme_id=>51
,p_name=>'ICON_GEAR'
,p_display_name=>'Gear'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513308453076987645)
,p_theme_id=>51
,p_name=>'ICON_GRID'
,p_display_name=>'Grid'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513308515219987645)
,p_theme_id=>51
,p_name=>'ICON_HOME'
,p_display_name=>'Home'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513308604886987645)
,p_theme_id=>51
,p_name=>'ICON_INFO'
,p_display_name=>'Info'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513308795158987646)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513308840620987646)
,p_theme_id=>51
,p_name=>'ICON_LOCK'
,p_display_name=>'Lock'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513308965574987646)
,p_theme_id=>51
,p_name=>'ICON_MAIL'
,p_display_name=>'Mail'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513309066455987646)
,p_theme_id=>51
,p_name=>'ICON_MINUS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513309197367987646)
,p_theme_id=>51
,p_name=>'ICON_PHONE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513309290693987646)
,p_theme_id=>51
,p_name=>'ICON_PLUS'
,p_display_name=>'Plus'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513309381182987646)
,p_theme_id=>51
,p_name=>'ICON_POWER'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513309456447987647)
,p_theme_id=>51
,p_name=>'ICON_REFRESH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513309533757987647)
,p_theme_id=>51
,p_name=>'ICON_SEARCH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513309665495987647)
,p_theme_id=>51
,p_name=>'ICON_STAR'
,p_display_name=>'Star'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513309748657987647)
,p_theme_id=>51
,p_name=>'ICON_TAG'
,p_display_name=>'Tag'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513309817245987647)
,p_theme_id=>51
,p_name=>'ICON_USER'
,p_display_name=>'User'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513310018345987648)
,p_theme_id=>51
,p_name=>'INLINE_BUTTON'
,p_display_name=>'Inline Button'
,p_display_sequence=>1
,p_button_template_id=>wwv_flow_api.id(15513309990198987648)
,p_css_classes=>'ui-btn-inline'
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15513310117430987648)
,p_theme_id=>51
,p_name=>'ROUNDED_CORNERS'
,p_display_name=>'Rounded Corners'
,p_display_sequence=>1
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(15513311180330987652)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(15513310980353987651)
,p_ui_type_name=>'JQM_SMARTPHONE'
...
,p_global_page_id=>0
,p_navigation_list_id=>wwv_flow_api.id(15513302379381987637)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>wwv_flow_api.id(15513305358462987643)
...
wwv_flow_api.create_page(
 p_id=>0
,p_user_interface_id=>wwv_flow_api.id(15513310980353987651)
...
,p_last_upd_yyyymmddhh24miss=>'20151026033618'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15513312511944987657)
,p_plug_name=>'Header'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(15513304202939987641)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15513312840279987657)
,p_plug_name=>'Footer'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(15513304043957987641)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15513312710586987657)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(15513312511944987657)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15513312660832987657)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(15513312947880987657)
,p_name=>'open panel'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(15513312660832987657)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(15513312947880987657)
,p_event_id=>wwv_flow_api.id(15513312947880987657)
,p_event_result=>'TRUE'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'RAMKOTTA@UTEXAS.EDU'
,p_last_upd_yyyymmddhh24miss=>'20151123165954'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15513952453777269767)
,p_plug_name=>'doREST'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(15513304502194987641)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(15514130756335269781)
,p_name=>'Results'
,p_template=>wwv_flow_api.id(15513304705751987641)
,p_display_sequence=>30
,p_include_in_reg_disp_sel_yn=>'N'
,p_region_template_options=>'#DEFAULT#'
...
'select ',
'jt1.major_name major, ',
'jt2.credit_hours "credits", ',
'jt3.avg_sal "avg sal",',
'jt4.avg_years_to_grad avg_years_to_grad,',
'jt5.main_building "main building",',
'jt6.deptno deptno',
'from apex_collections t, ',
'',
'json_table(t.clob001, ''$.MAJOR_NAME[*]'' COLUMNS rid for ordinality, major_name varchar2(30) path ''$'') jt1 , ',
'',
'json_table(t.clob001, ''$.CREDIT_HOURS[*]'' COLUMNS rid for ordinality, credit_hours number path ''$'') jt2 , ',
'',
'json_table(t.clob001, ''$.AVG_SAL[*]'' COLUMNS rid for ordinality, avg_sal number path ''$'') jt3 , ',
'',
'json_table(t.clob001, ''$.AVG_YEARS_TO_GRAD[*]'' COLUMNS rid for ordinality, avg_years_to_grad number path ''$'') jt4 , ',
'',
'json_table(t.clob001, ''$.MAIN_BUILDING[*]'' COLUMNS rid for ordinality, main_building varchar2(30) path ''$'') jt5,',
'',
'json_table(t.clob001, ''$.DEPTNO[*]'' COLUMNS rid for ordinality, deptno number path ''$'') jt6',
'',
...
,p_ajax_enabled=>'N'
,p_query_row_template=>wwv_flow_api.id(15513304833982987642)
,p_query_num_rows=>15
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(18151728706406484401)
,p_query_column_id=>1
,p_column_alias=>'MAJOR'
,p_column_display_sequence=>2
,p_column_heading=>'Major'
,p_use_as_row_header=>'N'
,p_disable_sort_column=>'N'
,p_report_column_width=>27
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(18151729353093484407)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(18151728979893484403)
,p_query_column_id=>3
,p_column_alias=>'avg sal'
,p_column_display_sequence=>3
,p_column_heading=>'Avg sal'
,p_use_as_row_header=>'N'
,p_disable_sort_column=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(17765514263534276324)
,p_query_column_id=>4
,p_column_alias=>'AVG_YEARS_TO_GRAD'
,p_column_display_sequence=>1
,p_column_heading=>'Avg years to grad'
,p_use_as_row_header=>'N'
,p_disable_sort_column=>'N'
,p_report_column_width=>20
,p_derived_column=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(18151729012618484404)
,p_query_column_id=>5
,p_column_alias=>'main building'
,p_column_display_sequence=>4
,p_column_heading=>'Main building'
,p_use_as_row_header=>'N'
,p_disable_sort_column=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(18151729242813484406)
,p_query_column_id=>6
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17765513635040276318)
,p_plug_name=>'Number of Students'
,p_parent_plug_id=>wwv_flow_api.id(15514130756335269781)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(15513304502194987641)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_flash_chart5(
 p_id=>wwv_flow_api.id(17765513720235276319)
,p_default_chart_type=>'3DPie'
,p_chart_title=>'Number of Students'
...
wwv_flow_api.create_flash_chart5_series(
 p_id=>wwv_flow_api.id(17765513852156276320)
,p_chart_id=>wwv_flow_api.id(17765513720235276319)
,p_series_seq=>10
,p_series_name=>'Number of Students'
,p_series_query=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select ',
'null,',
'jt1.major_name major_name, ',
'jt2.num_students num_students ',
'from apex_collections t,',
' ',
'json_table(t.clob001, ''$.MAJOR_NAME[*]'' COLUMNS rid for ordinality, major_name varchar2(30) path ''$'') jt1 , ',
'',
'json_table(t.clob001, ''$.NUM_STUDENTS[*]'' COLUMNS rid for ordinality, num_students number path ''$'') jt2',
'',
'where t.collection_name = ''P2_DOREST_RESULTS'' and ',
'jt1.rid = jt2.rid'))
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15513952866756269769)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(15513952453777269767)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(15513953239549269770)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15513954048325269773)
,p_name=>'P2_DB'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(15513952453777269767)
,p_item_default=>'jdbc:oracle:thin:@sayonara.microlab.cs.utexas.edu:1521:orcl'
,p_prompt=>'Db'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
,p_field_template=>wwv_flow_api.id(15513305516033987643)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15513954844071269776)
,p_name=>'P2_USER'
,p_item_sequence=>2
,p_item_plug_id=>wwv_flow_api.id(15513952453777269767)
,p_item_default=>'C##cs347_rk8596'
,p_prompt=>'User'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15513955676178269776)
,p_name=>'P2_PASS'
,p_item_sequence=>3
,p_item_plug_id=>wwv_flow_api.id(15513952453777269767)
,p_item_default=>'orcl_rk8596'
,p_prompt=>'Pass'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15513956409518269777)
,p_name=>'P2_MODE'
,p_item_sequence=>4
,p_item_plug_id=>wwv_flow_api.id(15513952453777269767)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15513957204174269777)
,p_name=>'P2_MODEL'
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(15513952453777269767)
,p_item_default=>'B3'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15514128086497269778)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15514128830136269779)
,p_name=>'P2_RETURNFOR'
,p_item_sequence=>7
,p_item_plug_id=>wwv_flow_api.id(15513952453777269767)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15514129699178269780)
,p_name=>'P2_QUERY'
,p_item_sequence=>8
,p_item_plug_id=>wwv_flow_api.id(15513952453777269767)
,p_item_default=>'"MATCH(a:major) RETURN a"'
,p_prompt=>'Query'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(15513953662075269771)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_WEB_SERVICE'
,p_process_name=>'Web Service Request'
,p_process_sql_clob=>'15513363997818027876:15513364181072027878'
,p_attribute_01=>wwv_flow_api.id(15513364181072027878)
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Rest Initial Project Part2 Mobile - Log In'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'OFF'
,p_step_template=>wwv_flow_api.id(15513302592617987638)
,p_page_template_options=>'#DEFAULT#'
,p_dialog_chained=>'Y'
,p_overwrite_navigation_list=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15513311439762987654)
,p_plug_name=>'Log In'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(15513304502194987641)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15513311754790987656)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(15513311439762987654)
,p_button_name=>'LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(15513309990198987648)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15513311517279987655)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(15513311439762987654)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15513311606575987655)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(15513311984335987656)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(15513311810291987656)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(15513312189688987656)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(15513312045367987656)
,p_process_sequence=>10
...
wwv_flow_api.create_web_service(
 p_id=>wwv_flow_api.id(15513363997818027876)
,p_name=>'RestfulReL'
...
wwv_flow_api.create_ws_operations(
 p_id=>wwv_flow_api.id(15513364181072027878)
,p_ws_id=>wwv_flow_api.id(15513363997818027876)
,p_name=>'doREST'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15513325419860221741)
,p_ws_opers_id=>wwv_flow_api.id(15513364181072027878)
,p_name=>'DB'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
);
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15513954440247269774)
,p_parameter_id=>wwv_flow_api.id(15513325419860221741)
,p_process_id=>wwv_flow_api.id(15513953662075269771)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_DB'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15513325732148221742)
,p_ws_opers_id=>wwv_flow_api.id(15513364181072027878)
,p_name=>'USER'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15513955269374269776)
,p_parameter_id=>wwv_flow_api.id(15513325732148221742)
,p_process_id=>wwv_flow_api.id(15513953662075269771)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_USER'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15513326071084221743)
,p_ws_opers_id=>wwv_flow_api.id(15513364181072027878)
,p_name=>'PASS'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15513956002822269777)
,p_parameter_id=>wwv_flow_api.id(15513326071084221743)
,p_process_id=>wwv_flow_api.id(15513953662075269771)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_PASS'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15513326375675221743)
,p_ws_opers_id=>wwv_flow_api.id(15513364181072027878)
,p_name=>'MODE'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15513956854525269777)
,p_parameter_id=>wwv_flow_api.id(15513326375675221743)
,p_process_id=>wwv_flow_api.id(15513953662075269771)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_MODE'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15513326604399221743)
,p_ws_opers_id=>wwv_flow_api.id(15513364181072027878)
,p_name=>'MODEL'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15513957624873269778)
,p_parameter_id=>wwv_flow_api.id(15513326604399221743)
,p_process_id=>wwv_flow_api.id(15513953662075269771)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_MODEL'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15513326906641221743)
,p_ws_opers_id=>wwv_flow_api.id(15513364181072027878)
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15514128467627269779)
,p_parameter_id=>wwv_flow_api.id(15513326906641221743)
,p_process_id=>wwv_flow_api.id(15513953662075269771)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_RETURNDIMENSIONS'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15513327238883221743)
,p_ws_opers_id=>wwv_flow_api.id(15513364181072027878)
,p_name=>'returnFor'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15514129289702269780)
,p_parameter_id=>wwv_flow_api.id(15513327238883221743)
,p_process_id=>wwv_flow_api.id(15513953662075269771)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_RETURNFOR'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15513364494499027881)
,p_ws_opers_id=>wwv_flow_api.id(15513364181072027878)
,p_name=>'query'
,p_input_or_output=>'I'
,p_parm_type=>'string'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15514130012595269781)
,p_parameter_id=>wwv_flow_api.id(15513364494499027881)
,p_process_id=>wwv_flow_api.id(15513953662075269771)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_QUERY'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15513364787949027882)
,p_ws_opers_id=>wwv_flow_api.id(15513364181072027878)
,p_name=>'json'
,p_input_or_output=>'O'
,p_parm_type=>'json'
